...
let allowedOrigins = ['https://popcornpal.netlify.app', 'http://localhost:1234', 'http://localhost:8080', 'https://66d8eb535cc7526b114a274b--popcornpal.netlify.app/', 'localhost:4200'];
app.use(cors({
